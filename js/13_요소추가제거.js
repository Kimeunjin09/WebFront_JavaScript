...
document.getElementById("add").addEventListener("click", function() {
    ...
    // span에 &times; 추가
    span.innerHTML = "&times;"; // 파서가 처리해야 할 애
    ...
    // div > input, span == div에 input, span 넣고 조립
...
// 정적으로 이벤트 걸기
// (계산 버튼을 누르는 시점의 이미 만들어진 HTML을 읽어오기 때문에_
// 동적으로 생기는 애한테는 동적이벤트를 걸어야한다고 생각하기
