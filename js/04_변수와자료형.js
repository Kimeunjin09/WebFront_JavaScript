...
console.log("num2 : " + num2); // 까지 검사창의 console에 바로 출력
...
// 함수 종료 후에는 사용 불가
// 오류는 console창에서 빨간글씨로 확인

// *** script 언어는 중간에 에러가 발생하면 해석을 멈춤
// -> 인터프리터가 한 줄씩 읽으면서 내려오기 때문에
...
function typeTest() {
    ...
    // console.log(temp3); // error, 블록범위 벗어남
    ...
    // const name2; // 덮어쓰기가 안되기 때문에 상수는 선언과 동시에 초기화가 필수!

    let name; // undefined
    typeBox.innerHTML += "name : " + name + " / " + typeof name;
                        // name : undefined / undifined
    ...
    // 함수명만 작성하는 경우 => 함수에 작성된 코드자체가 반환
    typeBox.innerHTML += "<br><br>fnSum : " + fnSum + "/" + typeof fnSum;
    // fnSum : function(n1, n2) { // 익명함수 return n1 + n2; }/function이렇게 나옴 == 코드 자체
